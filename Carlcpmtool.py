...
from Carlcpmtool import Carlcpm
...
def banner(console):
    ...
    brand_name +=  "                   ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝ ╚═════╝╚═╝     ╚═╝     ╚═╝\n"                                          
    colors = '['
         "File..."~/Cpmkaito rgb(0,255,255)","rgb(0,206,209)","rgb(0,191,255)","rgb(70,130,180)","rgb(0,0,255)",
    ...
    print(Colorate.Horizontal(Colors.rainbow, ' 𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐌𝐄 𝐓𝐎 𝐁𝐔𝐘 𝐔𝐍𝐋𝐈𝐌𝐈𝐓𝐄𝐃 𝐁𝐀𝐋𝐀𝐍𝐂𝐄 𝐓𝐆 @Carlcpm')) 
